    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('educational_level', models.CharField(choices=[('Basica primaria', 'Basica primaria'), ('Basica secundaria', 'Basica secundaria'), ('Bachillerato', 'Bachillerato'), ('Diplomado', 'Diplomado'), ('Tecnico', 'Tecnico'), ('Tecnologo', 'Tecnologo'), ('Ingeniero', 'Ingeniero'), ('Licenciatura', 'Licenciatura'), ('Master', 'Master'), ('Doctorado', 'Doctorado')], default='Bachillerato', max_length=50)),
