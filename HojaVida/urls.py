...
urlpatterns = [
    ...
    path('save/habilidades/', save_hj.save_habilidades ,  name='save_habilidades_hoja'),
    ...
    path('edit/habilidades/<int:id_usuario>/' , save_hj.edit_habilidad , name='edit_habilidades_hoja'),
    ...
    path('delete/habilidades/<int:id_usuario>/', save_hj.delete_habilidades ,  name='delete_habilidades_hoja'),
